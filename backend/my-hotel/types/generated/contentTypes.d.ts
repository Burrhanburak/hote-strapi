...
export interface ApiReservationReservation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<['confirmed', 'pending', 'canceled']>;
    room: Attribute.Relation<
      'api::reservation.reservation',
      'oneToOne',
      'api::room.room'
...
export interface ApiRoomRoom extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['double']>;
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description: Attribute.Text;
    price: Attribute.Integer;
    category: Attribute.Enumeration<['transport', 'spa', 'dining']>;
    orders: Attribute.Relation<
      'api::service.service',
      'manyToMany',
      'api::order.order'
